...
func (g *Gfield) AccMul(a Gfield, b Gfield) Gfield {
	...
	return Gfield(atable[(ltable[a]+ltable[b])%255])
}

// Algorithm is explained here: https://en.wikipedia.org/wiki/Finite_field_arithmetic#Rijndael's_(AES)_finite_field
func (g *Gfield) Mul(a Gfield, b Gfield) Gfield {
	var (
		op  = a
		op2 = b
		res = Gfield(0)
...
func (g *Gfield) Div(a Gfield, b Gfield) Gfield {
	if a == 1 {
		return Gfield(255 - ltable[b])
	}
	return Gfield((ltable[a] - ltable[b]) % 255)
}
